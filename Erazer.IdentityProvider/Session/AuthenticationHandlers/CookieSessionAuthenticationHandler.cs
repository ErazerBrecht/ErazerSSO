...
{
    public class CookieSessionAuthenticationHandler : SignInAuthenticationHandler<CookieAuthenticationOptions>
    {
        ...
        private const string SessionKeyClaim = "Erazer.SSO.Cookies.SessionKey";

        public CookieSessionAuthenticationHandler(IOptionsMonitor<CookieAuthenticationOptions> options,
            ILoggerFactory logger, UrlEncoder encoder, ISystemClock clock, ISessionService session)
        ...
        protected override async Task<AuthenticateResult> HandleAuthenticateAsync()
        {
            ...
            var context =
                new CookieValidatePrincipalContext(Context, Scheme, Options, result.Ticket);
        ...
        protected override async Task HandleSignInAsync(ClaimsPrincipal user, AuthenticationProperties properties)
        {
            ...
            var ticket = new AuthenticationTicket(signInContext.Principal, signInContext.Properties,
            ...
            if (shouldRedirectToReturnUrl && Response.StatusCode == 200)
            {
                ...
                if (redirectUri != null)
                {
                    await Events.RedirectToReturnUrl(
                        new RedirectContext<CookieAuthenticationOptions>(Context, Scheme, Options,
